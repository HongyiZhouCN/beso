...
from beso.envs.block_pushing import block_pushing
from beso.envs.block_pushing.utils import utils_pybullet
from beso.envs.block_pushing.utils.pose3d import Pose3d
from beso.envs.block_pushing.utils.utils_pybullet import ObjState
from beso.envs.block_pushing.utils.utils_pybullet import XarmState


# BLOCK2_URDF_PATH = path_ilfvrm('./experiments/blockpush/env/assets/block2.urdf') #"third_party/py/envs/assets/block2.urdf"
# ZONE2_URDF_PATH = path_ilfvrm('./experiments/blockpush/env/assets/zone2.urdf')
...
class BlockPushMultimodal(block_pushing.BlockPush):
    ...
    def __init__(
        ...
        self._step_num = 0
        self.tasks_to_complete = [0, 1, 2, 3]
    ...
    def _setup_pybullet_scene(self):
        ...
        # self._pybullet_client = pybullet.connect(pybullet.GUI)
    ...
    def step(self, action):
        ...
        return state, reward, done, {"all_completions": self.all_completions}
                ...
                if self._in_target[t_i][b_i] == -1:
                    ...
                    if dist < self.goal_dist_tolerance:
                        ...
                        if task_idx in self.tasks_to_complete:
                            ...
                            self.tasks_to_complete.remove(task_idx)
                        reward += 0.49
